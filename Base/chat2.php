...
<div class="chatBox z-depth-3" style="display: none; z-index: 999999">
    ...
    <div class="fixed-action-btn">
        <a class="btn-floating btn-large blue darken-1" id="openChat" >
    ...
    $("#formMensagem").submit(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.ajax({
                    url: "<?= $pontos; ?>Controle/chatControle.php?function=isFirstMessage&id_remetente=<?=$logado->getId_usuario()?>&id_destinatario=<?=$empregado->getId_usuario()?>",
                    success: function (data) {
                        console.log(data);
                        if (data === 1 || data === "1") {
